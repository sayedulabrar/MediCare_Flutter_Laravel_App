...
class DoctorInfo extends StatelessWidget {
  ...
  final int? patients; // Changed to int?
  final int? exp;      // Changed to int?
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        InfoCard(
          label: 'Patients',
          value: '${patients ?? 0}', // Provide default value if null
        ),
        const SizedBox(
          width: 15,
        ),
        InfoCard(
          label: 'Experiences',
          value: '${exp ?? 0} years', // Provide default value if null
        ),
        const SizedBox(
          width: 15,
        ),
